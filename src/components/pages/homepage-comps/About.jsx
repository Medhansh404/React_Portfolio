    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <p className="mb-4 py-6">Hey! I am an undergraduated from The LNM Institute of Information Technology. I've been immersed in the dynamic world of Web and Small scale software developement. I also enjoy the new advancements in the fied of AI/ML and like to ride around in the wave of new advancements.
                    </p>
