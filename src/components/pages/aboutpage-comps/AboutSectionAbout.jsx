            ...
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-24 lg:py-0 lg:flex-row lg:gap-8'>
                ...
                <div className='flex flex-col justify-center items-center h-[85%] md:h-full'>
                    ...
                    <div className='flex items-center bg-primary-color/20 rounded-md py-2 px-4'>
                        ...
                        <h2 className='text-lg sm:text-xl md:text-2xl md:py-1 font-semibold text-white'>Indian - 22 years old</h2>
                    </div>
                    
                    <p className='text-md md:text-lg text-gray-300 py-4 max-x-md text-justify'>I am an undergraduated from The LNM Institute of Information Technology. I've been immersed in the dynamic world of Web and Small scale software developement. I also enjoy the new advancements in the fied of AI/ML and like to ride around in the wave of new advancements.</p>
